...
namespace SkyBuilding.ORM
{
    ...
    public class Repository<T> : Repository, IRepository<T>, IOrderedQueryable<T>, IQueryable<T>, IEnumerable<T>, IOrderedQueryable, IQueryable, IEnumerable, IQueryProvider
    {
        ...
        private Repository(IReadOnlyConnectionConfig connectionConfig, Expression expression) : base(connectionConfig)
        {
        ...
        IQueryable<TElement> IQueryProvider.CreateQuery<TElement>(Expression expression)
        {
            ...
            return new Repository<TElement>(ConnectionConfig, expression);
        }
