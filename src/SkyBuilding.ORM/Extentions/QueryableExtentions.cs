...
namespace System.Linq
{
    ...
    public static class QueryableExtentions
    {
        ...
        public static IQueryable<TSource> From<TSource>(this IQueryable<TSource> source, Func<ITableRegions, string> table)
        {
            ...
            return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(From, source, table), new Expression[2] {
                source.Expression,
        ...
        public static TResult TakeFirst<TSource, TResult>(this IQueryable<TSource> source, Expression<Func<TSource, TResult>> selector)
        {
            ...
            return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(TakeFirst, source, selector), new Expression[2] {
                source.Expression,
        ...
        public static TResult TakeFirstOrDefault<TSource, TResult>(this IQueryable<TSource> source, Expression<Func<TSource, TResult>> selector)
        {
            ...
            return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(TakeFirstOrDefault, source, selector), new Expression[2] {
                source.Expression,
                Expression.Quote(selector)
            }));
        }
        ...
        public static TResult TakeSingle<TSource, TResult>(this IQueryable<TSource> source, Expression<Func<TSource, TResult>> selector) where TResult : class
        {
            ...
            return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(TakeSingle, source, selector), new Expression[2] {
                source.Expression,
                Expression.Quote(selector)
            }));
        }
        ...
        public static TResult TakeSingleOrDefault<TSource, TResult>(this IQueryable<TSource> source, Expression<Func<TSource, TResult>> selector) where TResult : class
        {
            ...
            return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(TakeSingleOrDefault, source, selector), new Expression[2] {
                source.Expression,
                Expression.Quote(selector)
            }));
        }
        ...
        public static TResult TakeLast<TSource, TResult>(this IQueryable<TSource> source, Expression<Func<TSource, TResult>> selector) where TResult : class
        {
            ...
            return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(TakeLast, source, selector), new Expression[2] {
                source.Expression,
                Expression.Quote(selector)
            }));
        }
        ...
        public static TResult TakeLastOrDefault<TSource, TResult>(this IQueryable<TSource> source, Expression<Func<TSource, TResult>> selector) where TResult : class
        {
            ...
            return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(TakeLastOrDefault, source, selector), new Expression[2] {
                source.Expression,
                Expression.Quote(selector)
            }));
        }
