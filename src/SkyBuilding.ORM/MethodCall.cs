namespace SkyBuilding.ORM
{
    ...
    public class MethodCall
    {
        ...
        public const string TakeFirstOrDefault = "TakeFirstOrDefault";
        public const string TakeSingle = "TakeSingle";
        public const string TakeSingleOrDefault = "TakeSingleOrDefault";
        public const string TakeLastOrDefault = "TakeLastOrDefault";
